<template>
	<div
		...
		:class="theme"
	>
		<header class="border-t-14 border-pink-700">
			<nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
				<div class="ml-8">
					<g-link v-if="theme === 'theme-light'" to="/">
						<g-image src="../../static/sakura_tree.svg" class="w-20 m-auto" alt="logo" />
						<h1 class="text-xl">Spooky Umi</h1>
					</g-link>
					<g-link v-else to="/">
						<g-image src="../../static/sakura_tree.svg" class="w-20 m-auto" alt="logo" />
						<h1 class="text-xl">Spooky Umi</h1>
				...
				>
					...
					<li class="mr-8 mb-6 lg:mb-0">
						...
						<g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">
							Projects
						</g-link>
					</li>
					<li class="mr-8 mb-6 lg:mb-0">
					...
					<li class="mr-8 mb-6 lg:mb-0">
						...
						<g-link v-else to="/#contact" class="text-copy-primary hover:text-gray-600">
							Contact
						</g-link>
					</li>
					<!-- <li class="mr-8 mb-6 lg:mb-0">
		...
		<footer class="bg-pink-700 text-white">
			<div class="container mx-auto flex-row items-center justify-between pt-8">
